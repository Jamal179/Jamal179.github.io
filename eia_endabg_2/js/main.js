...
(function (aufgabe13) {
    ...
    function schneemannFunktion(_x, _y) {
        let schneemann = new Path2D();
        aufgabe13.crc.lineWidth = 3;
        aufgabe13.crc.strokeStyle = "black";
        aufgabe13.crc.fillStyle = "white";
        schneemann.arc(_x, _y, 50, 0, 2 * Math.PI);
        aufgabe13.crc.stroke(schneemann);
        aufgabe13.crc.fill(schneemann);
        let schneemannMitte = new Path2D();
        schneemannMitte.arc(_x, _y - 80, 30, 0, 2 * Math.PI);
        aufgabe13.crc.stroke(schneemannMitte);
        aufgabe13.crc.fill(schneemannMitte);
        let schneemannKopf = new Path2D();
        aufgabe13.crc.strokeStyle = "black";
        aufgabe13.crc.fillStyle = "white";
        aufgabe13.crc.lineWidth = 3;
        schneemannKopf.arc(_x, _y - 122, 10, 0, 2 * Math.PI);
        aufgabe13.crc.stroke(schneemannKopf);
        aufgabe13.crc.fill(schneemannKopf);
    }
    ...
    function hintergrund() {
        ...
        aufgabe13.crc.fillStyle = "LemonChiffon";
        Sonne.arc(+700, 100, 100, 100, Math.PI, 2 * Math.PI);
        //      X/Y/RADIUS/BOGEN       /2mal pi = 360
        aufgabe13.crc.fill(Sonne);
        let SonnenMund = new Path2D();
        aufgabe13.crc.fillStyle = "black";
        aufgabe13.crc.fillRect(650, 90, 100, 4);
        aufgabe13.crc.fill(SonnenMund);
        let wolke = new Path2D();
        aufgabe13.crc.beginPath();
        aufgabe13.crc.moveTo(190, 71);
        aufgabe13.crc.bezierCurveTo(136, 110, 133, 155, 233, 155);
        aufgabe13.crc.bezierCurveTo(251, 170, 310, 182, 342, 152);
        aufgabe13.crc.bezierCurveTo(420, 150, 420, 120, 390, 100);
        aufgabe13.crc.bezierCurveTo(431, 44, 376, 38, 343, 50);
        aufgabe13.crc.bezierCurveTo(321, 2, 255, 29, 257, 54);
        aufgabe13.crc.bezierCurveTo(205, 4, 153, 23, 173, 83);
        ...
        aufgabe13.crc.fillRect(300, 350, 10, 200);
        aufgabe13.crc.fill(hausBein);
        let haus = new Path2D();
        aufgabe13.crc.fillStyle = "brown";
        aufgabe13.crc.fillRect(250, 250, 100, 100);
        aufgabe13.crc.clearRect(270, 270, 60, 60);
        aufgabe13.crc.strokeRect(275, 275, 50, 50);
        ...
        for (let i = 0; i < 60; i = i + 50) {
            let x = 675 + i;
            let augeSonne = new Path2D();
            augeSonne.arc(x, 75, 10, 0, 2 * Math.PI);
            aufgabe13.crc.fillStyle = "white";
            aufgabe13.crc.strokeStyle = "black";
            aufgabe13.crc.fill(augeSonne);
            aufgabe13.crc.stroke(augeSonne);
            let augeInnenSonne = new Path2D();
            augeInnenSonne.arc(x, 75, 5, 0, 2 * Math.PI);
            aufgabe13.crc.fillStyle = "black";
            aufgabe13.crc.fill(augeInnenSonne);
        }
    }
